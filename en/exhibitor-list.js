document.addEventListener("DOMContentLoaded", () => {
  ...
  // Sort data A-Z initially
  const sortedInitialData = [...participantsData].sort((a, b) => a.firmaAdi.localeCompare(b.firmaAdi, 'en'))
  ...
  function sortParticipants() {
    const sortedData = [...participantsData].sort((a, b) => {
      if (isAscending) {
        return a.firmaAdi.localeCompare(b.firmaAdi, 'en')
      } else {
        return b.firmaAdi.localeCompare(a.firmaAdi, 'en')
      }
    })
